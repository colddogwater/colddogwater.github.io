...
image: "blg-imgs/furnace/current1.jpg"
categories: hightemp 
---
...
<div class="image-row">
    <figure>
        <a href="{{ '/blg-imgs/furnace/og1.jpg' | relative_url }}" class="lightbox">
            <img src="{{ '/blg-imgs/furnace/og1.jpg' | relative_url }}" alt="First Image">
        </a>
        <figcaption>Birds eye view of the setup</figcaption>
    </figure>
    <figure>
        <a href="{{ '/blg-imgs/furnace/og2.jpg' | relative_url }}" class="lightbox">
            <img src="{{ '/blg-imgs/furnace/og2.jpg' | relative_url }}" alt="Second Image">
        </a>
...
<img src="{{ '/blg-imgs/furnace/current1.jpg' | relative_url }}" alt="Description" class="responsive-img">
...
<img src="{{ '/blg-imgs/furnace/nuggets.jpg' | relative_url }}" alt="Description" class="responsive-img">
